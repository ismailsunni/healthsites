    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(default=1, help_text=b'The status of the data loader..', verbose_name=b'Data Loader Status', choices=[(1, b'Pending'), (2, b'Rejected'), (3, b'Accepted')])),
                ('approver', models.ForeignKey(related_name='dataloader_approver', verbose_name=b'Approver', to=settings.AUTH_USER_MODEL, help_text=b'The user who approve the data loader.')),
